...
import type { MotionSegment, MotionSegmentInput, MotionTypeValue, Velocity } from "../types";
...
export const MotionType = {
  ...
  JITTER: "jitter"
} as const satisfies Record<string, MotionTypeValue>;
...
export function createMotionSegment({
  ...
  rng
}: MotionSegmentInput): MotionSegment {
  return {
    type,
    duration,
    speed,
...
export function getVelocityAt(segment: MotionSegment, localTime: number, dt = 0.016): Velocity {
